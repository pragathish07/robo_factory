...
const MotorAndGearboxes = () => {
  const [products, setProducts] = useState([]);
  const [sortingOption, setSortingOption] = useState('default');
  const [filteringOption, setFilteringOption] = useState('motorandgearboxes');
  ...
  return (
    <div className="MotorAndGearboxes">
      <h2>MotorAndGearboxes</h2>
      <div className="options-container">
        ...
        <div className="filter-options">
          ...
          >
            ...
            <option value="MotorAndGearboxes">MotorAndGearboxes</option>
...
export default MotorAndGearboxes;
